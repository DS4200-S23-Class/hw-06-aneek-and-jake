...
d3.csv("data/iris.csv").then(function(data) {
    ...
    const bar_graph = svg_3.append("g")
        .selectAll("rect")
        .data(counts)
        .enter()
        .append("rect")
    ...
    // Function executed once area is selected with brushing 
    function updateChart(event) {
        ...
        // Extracting the species of each point that is selected 
        let selectedSpecies = [];
        ...
        bar_graph.classed("selected", function(d) {
